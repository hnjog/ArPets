...
public class CameraScript : SampleController
{
    public WikitudeCamera wikiCamera;

    public void Start()
    {
        wikiCamera.FocusMode = CaptureFocusMode.Locked;
    }
    //// 디버깅용
    //public Text debug;
    //
    ...
    //void Update()
    //{
    //    transform.Translate(new Vector3( -Input.gyro.rotationRateUnbiased.y, Input.gyro.rotationRateUnbiased.x, 0) * Time.deltaTime * 5);
