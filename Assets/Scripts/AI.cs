...
public class AI : MonoBehaviour
{
	...
	[Header("행복도와 만복도")]
	[Range(0, 100)]
	public static int happiness;                       // 행복도 (기본수치 50, 최소 0, 최대 100)
	[Range(0, 100)]
	public static int foodPoint;                       // 만복도 (기본수치 50, 최소 0, 최대 100)

	public static int success = 0;                      //  성공 횟수 (먹이, 공놀이 성공 횟수)
	public static int fail = 0;                         //  실패 횟수 (먹이, 실패횟수)

	//[SerializeField] AudioSource veluga_AS = null;		// 오디오 소스
	//[SerializeField] AudioClip[] veluga_AC;				// 오디오 클립들
	...
	public enum Chara_State
	{
		...
		state_Hungry = 3,                     // 배고픔 상태    ( 배고픔 수치 확률로 실행되며 그 경우 관련 애니메이션을 재생하는 용도)
	...
	public static bool isStillMove = false;
}
